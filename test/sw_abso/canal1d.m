#$Id: canal1d.m,v 1.1.2.1 2003/10/16 19:09:27 mstorti Exp $
...
fid=fopen("canal1d.nod","w");
for j=1:nnodesn
  fprintf(fid,"%f %f %f\n",nod(j,1),nod(j,2),nod(j,3));
endfor
fclose(fid);

fid=fopen("canal1d.con","w");
for k=1:nnodes-1
  fprintf(fid,"%d %d\n",icone(k,1),icone(k,2));
endfor
fclose(fid);
