//__INSERT_LICENSE__
//$Id: bccnstherfm2.cpp,v 1.10.18.1 2007/02/24 02:00:51 mstorti Exp $
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "int bcconv_nsther_fm2::ask(char *,int &)"
int bcconv_nsther_fm2::ask(const char *jobinfo,int &skip_elemset) {
  skip_elemset = 1;
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "bcconv_nsther_fm2::assemble"
int bcconv_nsther_fm2::assemble(arg_data_list &arg_data_v,Nodedata *nodedata,
...
#define JDOFLOC(j,k) VEC2(jdofloc,j,k,ndof)
  ...
  //o Use a weak form for the gradient of pressure term and thermal equation.
...
#define WPG      (gp_data.wpg[ipg])
	...
	// Residual contribution due to integration by parts of thermal convection term
        tmp3_th = rho*Cp*double(tmp2_th.prod(normal,u_star,-1,-1));
