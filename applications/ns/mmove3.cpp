//__INSERT_LICENSE__
//$Id: mmove3.cpp,v 1.2 2002/12/12 00:04:48 mstorti Exp $
...
double mesh_move_old::distor_fun(FastMat2 & xlocp) {
...
void mesh_move_old::element_connector(const FastMat2 &xloc,
  ...
  int nen = nel*ndim;
  xloc0.reshape(2,nel,ndim).set(xloc).add(state_old)
    .reshape(1,nel*ndim);
