//$Id: swgalerkin1d.cpp,v 1.1.2.1 2004/08/31 20:15:51 rodrigop Exp $
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:
#include <stdio.h>
#include <string.h>
#include <cassert>
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::start_chunk(int &options) {
  ...
  EGETOPTDEF_ND(elemset,double,tau_fac,0.);
  assert(tau_fac==0.);
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::element_hook(ElementIterator &element) {
  channel->element_hook(element);
  friction_law->element_hook(element);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
swgalerkin1d_ff::swgalerkin1d_ff(const NewElemset *e) 
  : AdvDifFFWEnth(e), channel(NULL), 
  friction_law(NULL) {}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
swgalerkin1d_ff::~swgalerkin1d_ff() { delete friction_law; }

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::set_state(const FastMat2 &U) {
  UU.rs().set(U);
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::set_state(const FastMat2 &U,const FastMat2 &grad_U) {
  set_state(U);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::enthalpy(FastMat2 &H) {
  H.set(0.);
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_W_Cp_N(FastMat2 &W_Cp_N,const FastMat2 &W,const FastMat2 &N,
	      double weight) {
  W_Cp_N.set(0.);
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_P_Cp(FastMat2 &P_Cp,const FastMat2 &P_supg) {
  P_Cp.prod(P_supg,Cp,1,-1,-1,2);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::compute_flux(const FastMat2 &U,
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_A_grad_N(FastMat2 & A_grad_N,FastMat2 & grad_N) {
  A_grad_N.prod(A_jac,grad_N,-1,2,3,-1,1);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_N_N_C(FastMat2 &N_N_C,FastMat2 &N,double w) {
  tmp2.prod(N,N,1,2).scale(w);
  N_N_C.prod(tmp2,C_jac,1,3,2,4);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_N_P_C(FastMat2 &N_P_C, FastMat2 &P_supg,
			   FastMat2 &N,double w) {
  tmp3.prod(P_supg,C_jac,1,-1,-1,2).scale(w);
  N_P_C.prod(tmp3,N,1,3,2);
}
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
void swgalerkin1d_ff::comp_grad_N_D_grad_N(FastMat2 &grad_N_D_grad_N,
				    FastMat2 & grad_N,double w) {
  grad_N_D_grad_N.set(0.);
}

void swgalerkin1d_ff::Riemann_Inv(const FastMat2 &U, const FastMat2 &normaln,
