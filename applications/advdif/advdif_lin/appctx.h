/*$Id: appctx.h,v 1.1.2.1 2004/03/01 21:54:57 mstorti Exp $*/
/*
...
typedef struct {
  ...
  PetscTruth save_matrix;         /* saves matrix in sparse fashion */
...
//extern int MatISGetLocalMat(Mat mat, Mat *local);
