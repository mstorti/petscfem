// -*- mode: C++ -*- 
// $Id: swgalerkin1d.h,v 1.1.2.1 2004/08/31 20:16:29 rodrigop Exp $
#ifndef SWGALERKIN1D_H
#define SWGALERKIN1D_H
...
/** The flux function for flow in a channel with arbitrary shape and
    using galerkin for the shallow water 1d model (no supg, no shockcap)
*/ 
class swgalerkin1d_ff : public AdvDifFFWEnth {
  // problem dimension
  int ndim;
  // element dim
  int ndimel;
...
public:
  // Constructor
  swgalerkin1d_ff(const NewElemset *e);
  // Destructor
  ~swgalerkin1d_ff();
  /*
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
// The `swgalerkin1d' shallow water river or channel element.
class swgalerkin1d : public NewAdvDif {
public:
  swgalerkin1d() :  NewAdvDif(new swgalerkin1d_ff(this)) {} //constructor
};

class swgalerkin1d_abso : public AdvDiff_Abs_Nl_Res {
public:
  //swgalerkin1d_abso has n nodes [U_N, U_{N-1},U_{N-2}, .. , U_dummy]^t
  swgalerkin1d_abso() :  AdvDiff_Abs_Nl_Res(new swgalerkin1d_ff(this)) {
  } //constructor
};
