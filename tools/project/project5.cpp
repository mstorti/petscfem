...
int main() {
  //#define DATA_DIR "./"
#define DATA_DIR "/u/rodrigop/CONSULTORIA/SIDERAR/MESH_D_10/interp"
#if 0
...
#else
#define XNOD1  DATA_DIR "/sinter_plant-d-100.nod"
#define ICONE1 DATA_DIR "/sinter_plant-d-100.con"
#define STATE1 DATA_DIR "/sinter_plant-d-100.state.tmp"
#define XNOD2  DATA_DIR "/sinter_plant-d-10.nod"
#endif
