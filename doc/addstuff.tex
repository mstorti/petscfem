...
PETSc-FEM kernel, NS and AdvDif modules, Fluid-Structure Interactionm Linear Solvers. 
\item[Norberto M. Nigro (CIMEC)]
PETSc-FEM kernel, NS and AdvDif modules, Multi-phase flow. 
\item[Rodrigo R. Paz (CIMEC)]
AdvDif module, Hydrology module, Absorbent B.C., Compressible Flow,
ALE/Fluid-Structure Interaction, Linear Solvers and Preconditioners.
\item[Lisandro D. Dalc\'\i{}n (CIMEC)]
PETSc-FEM Kernel, Python Extension Language Project, Linear Algebra, Preconditioners.
\item[Ezequiel López (CIMEC)]
Mesh Relocation Algorithms (mesh-move). 
\item[Laura Battaglia (CIMEC)]
Free Surface Algorithms. 
\item[Gustavo Rios Rodr\guez (CIMEC)]
Adaptive Refinement. 
\end{description}
%
