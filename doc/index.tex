%__INSERT_LICENSE__
%$Id: index.tex,v 1.13 2004/11/30 21:56:00 mstorti Exp $
...
\begin{itemize}
\item the \htmladdnormallink{README}{./README.html} file contains
...
\htmladdnormallink{PostScript}{petscfem.ps.gz}, and
\htmladdnormallink{PDF}{petscfem.pdf}). The HTML version can be
downloaded with the doc packages in the download link below. 

\item The \htmladdnormallink{manual pages}{manual/html/index.html} for
...
(also available in \htmladdnormallink{PostScript}{manual.ps.gz}). The
...
\item \htmladdnormallink{\textbf{hahah Browse sources}}
  {http://www.cimec.org.ar/\~{}mstorti/petscfem/.git/gitweb/gitweb.cgi?p=.git;a=tree}
%  {http://www.cimec.org.ar/\%7emstorti/petscfem/.git/gitweb/gitweb.cgi?p=.git;a=tree}
