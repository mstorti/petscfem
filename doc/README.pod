...
Once you got the I<petscfem-beta-3.03.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-3.03.tar.gz
  $ tar xvf petscfem-beta-3.03.tar

This will create a I<petscfem-beta-3.03> directory with
