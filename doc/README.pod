...
Once you got the I<petscfem-beta-2.39.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-2.39.tar.gz
  $ tar xvf petscfem-beta-2.39.tar

This will create a I<petscfem-beta-2.39> directory with
