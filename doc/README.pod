...
Once you got the I<petscfem-beta-2.72.pl1.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-2.72.pl1.tar.gz
  $ tar xvf petscfem-beta-2.72.pl1.tar

This will create a I<petscfem-beta-2.72.pl1> directory with
