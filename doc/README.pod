...
(http://www.mcs.anl.gov/mpich) but I think there will be not problem
with LAM MPI.

=item PETSC

This is the 'Portable, Extensible Toolkit for Scientific Computation'
and can be found at http://www.mcs.anl.gov/petsc/
...
web site is http://www.gtk.org/ [RedHat RPM packages: C<GLIB>,
C<glib-devel>]
...
http://www.engelschall.com/sw/eperl/ ). B<ePerl> allows you to embed
...
http://MarginalHacks.com . License: GPL (See C<tools/eperl_license.txt>). 
...
B<e-mail:> <mstorti@intec.unl.edu.ar>

=item *

B<www:> http://www.cimec.org.ar/petscfem
