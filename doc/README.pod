...
of efficiency. PETSc-FEM runs in parallel using the MPI standard on a
variety of architectures, but currently has been tested in Beowulf
clusters. 
...
Once you got the I<petscfem-beta-3.02.pl17.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-3.02.pl17.tar.gz
  $ tar xvf petscfem-beta-3.02.pl17.tar

This will create a I<petscfem-beta-3.02.pl17> directory with
...
B<www:> C<http://minerva.ceride.gov.ar/petscfem>
