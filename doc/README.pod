...
based on Intel processors, running the GNU/Linux OS.  Of course, you
...
Once you got the I<petscfem-beta-1.7.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-1.7.tar.gz
  $ tar xvf petscfem-beta-1.7.tar

This will create a I<petscfem-beta-1.7> directory with
...
The reamining are Makefile variables that point to directories
