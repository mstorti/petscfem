...
(C) 1999-2004, Mario Alberto Storti, Norberto Marcelo Nigro, Rodrigo
Rafael Paz and Lisandro Dalcin, Centro Internacional de Metodos
...
I<Message Passing Interface>. We are currently using MPICH 1.2.1
(L<http://www.mcs.anl.gov/mpich>) but I think there will be no problem
with LAM MPI.
...
L<http://www.engelschall.com/sw/eperl/>). B<ePerl> allows you to embed
...
L<http://MarginalHacks.com>. License: GPL (See C<tools/eperl_license.txt>). 
...
=item Mario A. Storti* C<< <mstorti@intec.unl.edu.ar> >>
