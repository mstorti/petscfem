...
Once you got the I<petscfem-beta-1.53.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-1.53.tar.gz
  $ tar xvf petscfem-beta-1.53.tar

This will create a I<petscfem-beta-1.53> directory with
