...
equations. Can be found at C<http://acts.nersc.gov/superlu/>
...
Once you got the I<petscfem-beta-2.07.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-2.07.tar.gz
  $ tar xvf petscfem-beta-2.07.tar

This will create a I<petscfem-beta-2.07> directory with
