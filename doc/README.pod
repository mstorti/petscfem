...
Once you got the I<petscfem-beta-2.12.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-2.12.tar.gz
  $ tar xvf petscfem-beta-2.12.tar

This will create a I<petscfem-beta-2.12> directory with
