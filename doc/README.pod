...
Once you got the I<petscfem-beta-2.41.tar.gz> package,
gunzip and untar it like this:

  $ gunzip petscfem-beta-2.41.tar.gz
  $ tar xvf petscfem-beta-2.41.tar

This will create a I<petscfem-beta-2.41> directory with
