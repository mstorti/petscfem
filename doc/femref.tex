% $Id: femref.tex,v 1.7 2004/11/27 16:08:01 mstorti Exp $
...
determined from the nodes sequence itself. We we call this ordering
...
possibility os to take the caonical order as that one that gives the
