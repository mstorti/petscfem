% $Id: femref.tex,v 1.5 2004/11/27 14:51:19 mstorti Exp $
...
\item Unoriented hexas are described by numbering one of the faces as
  ...
  face. Symmetries are generated by permutation of any two of the
  faces (not opposite), for instance \verb+(1 2 3 0 5 6 7 0)+ and
  \verb+(1 5 6 2 0 4 7 3)+ and inversion \verb+(1 0 2 3)+ (232
