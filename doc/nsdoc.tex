...
prisms must be splitted in some number of these basic DX geometries.
...
PETSc-FEM geometry, one could use the line {\tt 1 2 4 3 quads}. That
...
triangles}. As another example, the prism element is splitted in 3
