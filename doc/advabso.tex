%__INSERT_LICENSE__
% $Id: advabso.tex,v 1.6 2005/02/09 12:49:44 mstorti Exp $ 
...
and a in fact a simple centered finite difference approximation to the
equations is presented. Alternatively, it can be thought as a pure
Galerkin FEM discretization with mass lumping. In the base of the
characteristic variables $!V$ this could be written as
%
\begin{equation} 
  \begin{aligned} 
    ...
    \bzL\,\frac{!V_{k+1}^{n+1}-!V_{k-1}^{n}}{h} &= 0. \\
  \end{aligned}
\end{equation}
%
For the boundary 
