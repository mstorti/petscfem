...
%     Latex2Html soen't like it. 
% 4./ After adding documentation, please check that it process
%     OK. That equation numbering is OK in the HTML output. Also that
%     image processing in the generation of the manual is OK. 
%
%---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
%Section{
%<: if (!$html) { :>
\newif\ifpdf \ifx\pdfoutput\undefined \pdffalse % Not running PDFLaTeX
\usepackage[dvips]{graphicx} \def\EPSPDF{eps} \else \pdfoutput=1 %
Running PDFLaTeX \pdftrue \usepackage[pdftex]{graphicx}
\pdfcompresslevel=9 \def\EPSPDF{pdf} \fi
%<: } else { :>
...
\latex{\newcommand{\funhead}[2]{\boxedb{{\tt #1}\textbf{: #2}}}}
...
\date{\today}
\maketitle 
%{\tiny\verb+$Id: petscfem.in.tex,v 1.15 2002/07/28 16:45:42 mstorti Exp $+}
%
\begin{abstract}
...
# eval: (setq latex-run-command "make dvi") $
# eval: (setq tex-command "make petscfem.tex ; latex petscfem") $
# End: $
