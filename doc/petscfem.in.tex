...
%     not process it.
% 3./ Do not use the `algorithmic' environment. Latex2Html soen't like
%     it. However you can use the `algorithm' environment.
...
\newcommand{\vrbsl}[1]{{\rm\slshape \html{\*#1\*}\latex{#1}}}
...
\date{\today}
\maketitle 
%{\tiny\verb+$Id: petscfem.in.tex,v 1.13 2002/07/28 12:44:26 mstorti Exp $+}
%
\begin{abstract}
