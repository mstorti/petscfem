//__INSERT_LICENSE__
//$Id: elmsupl.cpp,v 1.30.40.1 2006/05/20 21:11:19 dalcinl Exp $
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "upload_vector_fast"
// New Fast PETSc matrix loading version (uses MatSetValues)
extern int any_A_LL_other_stop;
int Elemset::upload_vector_fast(int nel,int ndof,Dofmap *dofmap,
		  int options,arg_data &argd,int myrank,
		  int el_start,int el_last,int iter_mode,
		  int klocc,int kdofc) {
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "upload_vector_slow"
int Elemset::upload_vector_slow(int nel,int ndof,Dofmap *dofmap,
		  int options,arg_data &argd,int myrank,
		  int el_start,int el_last,int iter_mode,
		  int klocc,int kdofc) {
