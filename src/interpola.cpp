//__INSERT_LICENSE__
//$Id: interpola.cpp,v 1.1 2003/06/08 21:42:01 mstorti Exp $
...
void interpolation::
read(FileStack *fstack,Mesh *mesh,Dofmap *dofmap) {
  TextHashTable *thash = new TextHashTable;
  thash->read(fstack);

  int ierr;
  //o The space dimension
  TGETOPTNDEF(thash,int,ndim,0);
  assert(ndim>0);
  ...
  points.reshape(2,npoints,ndim);
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "int advective::ask(char *,int &)"
int interpolation_e::ask(const char *jobinfo,int &skip_elemset) {
   skip_elemset = 1;
   return 0;
}
...
//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "void interpola::initialize"
void interpolation_e::initialize() {
}

//---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---:---<*>---: 
#undef __FUNC__
#define __FUNC__ "interpola::assemble"
void interpolation_e::
