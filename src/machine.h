...
/* RCS id: $Id: machine.h,v 1.1.1.1.128.1 2007/01/29 21:07:57 dalcinl Exp $ */
...
// fixme:= This next collides with `petsc-2.0.24/bmake/linux/petscconf.h'
...
#ifndef HUGE_VAL
// fixme:= This collides with `petsc-2.0.24/bmake/linux/petscconf.h'
