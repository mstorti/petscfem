...
void h5_dvector_write(dvector<double> &w,const char *filename,const char *varname,int step=INT_MAX);
...
void h5_dvector_write(dvector<double> &w,const char *fdname,int step=INT_MAX);
void h5_dvector_write(dvector<int> &w,const char *fdname,int step=INT_MAX);
